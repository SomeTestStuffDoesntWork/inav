...
#define BOARD_INITPINS_LCDIF_VSYNC_PERIPHERAL                              GPIO2   /*!< Peripheral name */
#define BOARD_INITPINS_LCDIF_VSYNC_SIGNAL                                gpio_io   /*!< Signal name */
#define BOARD_INITPINS_LCDIF_VSYNC_CHANNEL                                    3U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITPINS_LCDIF_VSYNC_GPIO                                    GPIO2   /*!< GPIO peripheral base pointer */
#define BOARD_INITPINS_LCDIF_VSYNC_GPIO_PIN                                   3U   /*!< GPIO pin number */
#define BOARD_INITPINS_LCDIF_VSYNC_GPIO_PIN_MASK                      (1U << 3U)   /*!< GPIO pin mask */
#define BOARD_INITPINS_LCDIF_VSYNC_PORT                                    GPIO2   /*!< PORT peripheral base pointer */
#define BOARD_INITPINS_LCDIF_VSYNC_PIN                                        3U   /*!< PORT pin number */
#define BOARD_INITPINS_LCDIF_VSYNC_PIN_MASK                           (1U << 3U)   /*!< PORT pin mask */
