...
set(MIMXRT106X_SDK_UTILITIES_DIR "${MIMXRT106X_SDK_SRC_DIR}/utilities")
set(MIMXRT106X_SDK_XIP_DIR "${MIMXRT106X_SDK_SRC_DIR}/xip")

# Contains all 106X specializations (Ex MIMXRT-1062). Specializations maintained internally via checks on macros.
set(MIMXRT106X_SYSTEM_DIR "${MAIN_SRC_DIR}/target/_system_mimxrt106x")

# Contains all 106X implementations (IE VCOM, etc.)
set(MIMXRT106X_DEVICE_IMPL_DIR "${MIMXRT106X_SYSTEM_DIR}/utilities")

# Grab all common 106X SDK components.
file(GLOB_RECURSE MIMXRT106X_SDK_SRC "${MIMXRT106X_SDK_SRC_DIR}/*.c")

# Do not use recurse so that chip specific sources are not added.
file(GLOB MIMXRT106X_COMMON_SRC "${MIMXRT106X_SYSTEM_DIR}/*.c")
file(GLOB MIMXRT106X_DEVICE_IMPL_SRC "${MIMXRT106X_DEVICE_IMPL_DIR}/*.c")
...
set(MIMXRT106X_INCLUDE_DIRS
    ...
    ${MIMXRT106X_SDK_UTILITIES_DIR}
    ${MIMXRT106X_SYSTEM_DIR}
    ${MIMXRT106X_DEVICE_IMPL_DIR}
)
...
function(target_mimxrt106x)
    target_mimxrt1xxx(
        SOURCES ${MIMXRT106X_SDK_SRC} ${MIMXRT106X_COMMON_SRC} ${MIMXRT106X_DEVICE_IMPL_SRC}
...
# MIMXRT1062 Targets **************************************************************************************************
set(MIMXRT1062_SRC_DIR "${MIMXRT106X_SYSTEM_DIR}/mimxrt1062")

file(GLOB_RECURSE MIMXRT1062_SRC "${MIMXRT1062_SRC_DIR}/*.c")
